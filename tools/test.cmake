...
assert_contains("${repo}/.qiven/generated-state.cmake" "0.1.6")
...
assert_contains("${app_repo}/.qiven/generated-state.cmake" "0.1.6")
...
string(REPLACE "0.1.6" "0.1.7-test" manifest "${manifest}")
...
assert_contains("${repo}/.qiven/generated-state.cmake" "0.1.7-test")
...
if(NOT synced_repo_version STREQUAL "0.1.7-test" OR NOT QIVEN_TEMPLATE_VERSION STREQUAL synced_repo_version)
...
string(REPLACE "0.1.6" "0.1.7-add" add_manifest "${add_manifest}")
...
string(REPLACE "0.1.6" "0.1.7-remove" remove_manifest "${remove_manifest}")
...
string(REPLACE "0.1.6" "0.1.7-rename" rename_manifest "${rename_manifest}")
