...
assert_contains("${repo}/.qiven/generated-state.cmake" "0.1.5")
...
string(REPLACE "0.1.5" "0.1.6-test" manifest "${manifest}")
...
assert_contains("${repo}/.qiven/generated-state.cmake" "0.1.6-test")
...
if(NOT synced_repo_version STREQUAL "0.1.6-test" OR NOT QIVEN_TEMPLATE_VERSION STREQUAL synced_repo_version)
...
string(REPLACE "0.1.5" "0.1.6-add" add_manifest "${add_manifest}")
...
string(REPLACE "0.1.5" "0.1.6-remove" remove_manifest "${remove_manifest}")
...
string(REPLACE "0.1.5" "0.1.6-rename" rename_manifest "${rename_manifest}")
