...
assert_contains("${repo}/.qiven/generated-state.cmake" "0.1.2")
...
string(REPLACE "0.1.2" "0.1.3-test" manifest "${manifest}")
...
assert_contains("${repo}/.qiven/generated-state.cmake" "0.1.3-test")
...
if(NOT synced_repo_version STREQUAL "0.1.3-test" OR NOT QIVEN_TEMPLATE_VERSION STREQUAL synced_repo_version)
...
string(REPLACE "0.1.2" "0.1.3-add" add_manifest "${add_manifest}")
...
string(REPLACE "0.1.2" "0.1.3-remove" remove_manifest "${remove_manifest}")
...
string(REPLACE "0.1.2" "0.1.3-rename" rename_manifest "${rename_manifest}")
