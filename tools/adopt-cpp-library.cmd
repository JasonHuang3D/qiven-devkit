...
"%QIVEN_CMAKE%" -DDEVKIT_ROOT="%~dp0.." -DMODE="%~1" -DREPOSITORY="%~2" -DREPOSITORY_NAME="%~3" -DCMAKE_PROJECT_NAME="%~4" -DCMAKE_TARGET_NAME="%~5" -DCMAKE_ALIAS="%~6" -DCPP_NAMESPACE="%~7" -DTEST_OPTION_NAME="%~8" -DVS_SOLUTION_NAME="%SOLUTION%" -P "%~dp0..\cmake\QivenRepoAdopt.cmake"
exit /b %errorlevel%
:usage
