...
cmake_path(ABSOLUTE_PATH git_root NORMALIZE OUTPUT_VARIABLE normalized_git_root)
if(WIN32)
    string(TOLOWER "${repository}" repository_compare)
    string(TOLOWER "${normalized_git_root}" git_root_compare)
else()
    set(repository_compare "${repository}")
    set(git_root_compare "${normalized_git_root}")
endif()
